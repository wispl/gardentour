...
object PlaceRepository {
    ...
    private val places = mapOf(
        ...
        "Washington Street Mall" to PlaceData(
        ...
        "Jersey Shore Alpacas" to PlaceData(
        ...
        "Cape May Lighthouse" to PlaceData(
            "Cape May Lighthouse",
        ...
        "Emlen Physick Estate" to PlaceData(
        ...
        "Naval Air Station Wildwood Aviation Museum" to PlaceData(
        ...
        "World War II Lookout Tower" to PlaceData(
